...
define(function(require,exports,module){
	...
	var aSrc=['./static/imgs/pic01.png','./static/imgs/pic02.png','./static/imgs/pic03.png','./static/imgs/pic04.png','./static/imgs/pic05.png','./static/imgs/pic06.png','./static/imgs/pic07.png'];
	var num=1;
	var iSrcNow=0;
	...
	function creatMsg(){
		if(message.code===''||message.content===''||message.contact==='填电话或者邮箱'||message.name==='输入名字或昵称'||message.theme==='输入主题或关于什么'){
			alert('有必填项目未填写！！请完善')
		}else{
			...
			$.ajax({
				...
				success: function (scheck){
					...
					if(scheck!=='200'){
						...
						$("#showList").prepend('<li><div class="messageListBox clear" style=" opacity: 1; filter: alpha(opacity=100); -webkit-transform: rotateY(0deg);"><div class="picture"><img src="'+picSrc+'"/></div>'+dv+'</li>');

						$("#messageList").height($("#showList").height());
						
						$("#theme").value='输入主题或关于什么';
						$("#name").value='输入名字或昵称';
						$("#content").value='';
						$("#phone").value='填电话或者邮箱';
						$("#code").value='';
	...
	function addMsg(){
		if(message.code===''||message.content===''||message.contact==='填电话或者邮箱'||message.name==='输入名字或昵称'){
			alert('有必填项目未填写！！请完善')
		}else{
